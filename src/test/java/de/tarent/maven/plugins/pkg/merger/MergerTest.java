...
public class MergerTest extends TestCase {
	...
	public void ObjectMergerPropertiesTest() {
		...
		// The objets for testPropertyKey in parent and child should not be the
		// same
		assertNotSame(child.get("testPropertyKey"),
				parent.get("testPropertyKey"));
		...
		assertTrue(child.getProperty("testPropertyKey").equals(
				"newPropertyValue"));
		assertTrue(child.getProperty("testPropertyKey2").equals(
				"InheritedValue"));
	}

	@Test
	@SuppressWarnings("unchecked")
	public void ObjectMergerCollectionsTest() throws InstantiationException,
