    ...
    extends AbstractPackagingMojo
{
  ...
  public class Helper implements IPackagingHelper
  {
     ...
     * 
     * @return size of copied files in byte
     * @throws MojoExecutionException
     */
	...
	protected final long writeScript(String item, File srcScriptFile, File dstScriptFile) throws MojoExecutionException {
		...
		try {
			...
			writer.println();
			writer.println("prefix=\"" + getTargetRoot() + "\"");
			writer.println("bindir=\"" + getTargetBinDir() + "\"");
			writer.println("datadir=\"" + getTargetDataDir() + "\"");
			writer.println("datarootdir=\"" + getTargetDatarootDir() + "\"");
			writer.println("sysconfdir=\"" + getTargetSysconfDir() + "\"");
			writer.println("jnidir=\"" + getTargetJNIDir() + "\"");
			writer.println("bundledjardir=\"" + getTargetBundledJarDir() + "\"");
			writer.println("wrapperscriptfile=\"" + getTargetWrapperScriptFile() + "\"");
			writer.println("version=\"" + getPackageVersion() + "\"");
			writer.println("name=\"" + getPackageName() + "\"");
			writer.println("mainClass=\"" + dc.getMainClass() + "\"");
			writer.println("scriptType=\"" + item + "\"");
			writer.println();
			writer.println("distro=\"" + dc.getChosenDistro() + "\"");
      ...
      throws MojoExecutionException
  {
    ...
    try
      {
        // Notice only compilation and runtime dependencies which are Jars.
