...
class WrapperScriptGenerator
{
  ...
  public void generate(File file) throws IOException
  {
   ...
   w.println("exec ${JAVA} "+getMemParameter()+" ${VMARGS} ${CLASSPATH_ARG} ${LIBRARY_PATH_ARG} ${DB_PATH_ARG} ${SYSTEM_PROPERTIES} ${MAIN_CLASS} ${@}");
  ...
  public void generateBatchFile(File file) throws IOException
  {
   ...
   w.println("start javaw "+getMemParameter()+" %CLASSPATH_ARG% %LIBRARY_PATH_ARG% %DB_PATH_ARG% %SYSTEM_PROPERTIES% %MAIN_CLASS% %1 %2 %3 %4 %5 %6 %7 %8 %9");
